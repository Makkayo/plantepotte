...
|:------:|-----|:------:|-------|
| ⬜ | ESP32 32S DevKit (30-pin) | ×2 | |
| ⬜ | LR7843 MOSFET-modul | ×4 | |
| ⬜ | LED-strip phyto 12V 5050 (5m) | ×1 | |
| ⬜ | 12V 3A adapter | ×1 | |
| ⬜ | DC barrel jack pigtail-par | ×1 | |
| ⬜ | Breadboard MB-102 + jumpere | ×2 | |
| ⬜ | Buck converter 5V/5A | ×1 | |
| ⬜ | LED clip connector 8mm | ×1 | |
| ⬜ | Terminalblokk KF301 2P | ×1 | |
| 📦 | Vekemateriale bomullssnor 3mm | ×1 | Kom 6. juni |
| ⬜ | Elektrisk tape | ×1 | |
| ⬜ | XKC-Y25 (reserve) | ×4 | |
| ⬜ | KY-040 rotary encoder | ×1 | |
| ⬜ | Jordfuktsensor kapasitiv v2.0 | ×1 (3stk) | |
| ⬜ | OLED SSD1306 0.96" | ×1 | |
| ⬜ | DHT22 (AM2302) | ×1 | |
...
| ⬜ | Dupont jumper F-F 30cm | ×1 | |
| ⬜ | Lever-connectors (Wago-klone) 50stk | ×1 | |
