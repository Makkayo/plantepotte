...
print(f"")
print(f"  VL53L0X (vannivaa): ~25 x 11 x 3 mm — paa avtagbart laser-lokk over berolings-broenn")
print(f"  Ingenting festes paa tanken (loeftes fritt ut); laseren henger i topp-konstruksjonen")
